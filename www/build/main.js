...
var ClockCheckPage = /** @class */ (function () {
    ...
    ClockCheckPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */], __WEBPACK_IMPORTED_MODULE_3__providers_clock_in_out_service_clock_in_out_service__["a" /* ClockInOutServiceProvider */]])
    ], ClockCheckPage);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/pablo/Documentos/Work/SchedulieAttendance/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Demo Company</ion-title>\n    <ion-buttons end>\n      <button ion-button round outline color="danger">Help Me</button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content >\n\n    <ion-card >\n\n        <ion-card-header text-center>\n          <h1>Employee Attendance</h1>\n        </ion-card-header>\n        \n        <ion-card-content >\n            <ion-list>\n              <ion-item style="font-size: 30px;"> \n                  <ion-input disabled=true [(ngModel)]="ngIdEmployee" maxlength="4" text-center type="password" placeholder="Employee PIN"></ion-input>\n              </ion-item>\n            \n            </ion-list>\n          \n            <div padding text-center >\n              <ion-grid   >\n                <ion-row style="justify-content: center;">\n                  <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'1\')">1</button></ion-col>\n                  <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'2\')">2</button></ion-col>\n                  <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'3\')">3</button></ion-col>\n                  \n                </ion-row>\n                \n                <ion-row style="justify-content: center;">\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'4\')">4</button></ion-col>\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'5\')">5</button></ion-col>\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'6\')">6</button></ion-col>\n      \n                </ion-row>\n      \n                <ion-row style="justify-content: center;">\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'7\')">7</button></ion-col>\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'8\')">8</button></ion-col>\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'9\')">9</button></ion-col>\n      \n                </ion-row>\n      \n                <ion-row style="justify-content: center;">\n                    <ion-col col-2 ><button ion-button round style="height:8rem; width:8rem; font-size: 2.4rem; border-radius: 10%;"  color="primary" (click)="showPrompt()"><ion-icon name="key"></ion-icon></button></ion-col>\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'0\')">0</button></ion-col>\n                    <ion-col col-2> <button ion-button round style="height:8rem; width:8rem; font-size: 2.5rem; border-radius: 10%;"  color="primary" (click)="numberPad(\'back\')"><ion-icon name="arrow-round-back"></ion-icon></button></ion-col>\n\n                </ion-row>\n              </ion-grid>\n            </div>\n        </ion-card-content>\n      </ion-card>\n</ion-content>\n'/*ion-inline-end:"/Users/pablo/Documentos/Work/SchedulieAttendance/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ToastController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_4__providers_clock_in_out_service_clock_in_out_service__["a" /* ClockInOutServiceProvider */],
